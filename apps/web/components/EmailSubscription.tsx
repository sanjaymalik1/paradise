...
export default function EmailSubscription() {
  ...
  return (
    <section className="mt-12 xl:mt-16 mb-8">
      {/* <div className="max-w-7xl mx-auto">
        <div className="bg-white rounded-l border border-gray-300 p-6"> */}
          <div className="h-20 xl:h-28 w-[90%] max-w-7xl mx-auto flex items-center justify-between rounded-l border border-gray-300 p-6">
